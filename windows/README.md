...
3. **Run the dev build**
   ...
   This launches a transparent, taskbar-skipping window. Use the global shortcut (default: `Ctrl+Shift+Space`) to toggle visibility while testing.
...
| Overlay toggle | `toggle_overlay_visibility` command | Wire this to a shortcut or backend event to show inspectable UI when needed. |
